...
experiment_params['tag'] = ['prior_1_obs_gap_{:.2f}'.format(gap) for gap in model_params['obs_gap']]
...
_experiment_params['tag'] = ['prior_3_obs_gap_{:.2f}'.format(gap) for gap in model_params['obs_gap']]
