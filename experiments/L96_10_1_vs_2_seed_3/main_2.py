...
model_params['prior_cov'] = [0.5] * num_experiments
model_params['shift'] = [2.0] * num_experiments
...
experiment_params['tag'] = ['prior_2_gap_{:.2f}'.format(gap) for gap in model_params['obs_gap']] 
...
for i in range(num_experiments):
    ...
    true_trajectories.a ppend(gen_path(model_params['x0'][i], model_params['ev_time'][i]))
